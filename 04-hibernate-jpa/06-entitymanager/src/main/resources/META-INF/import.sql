...
--
--insert into product_tbl(name,price,category_id) values('Orange',2000.00,1);
--insert into product_tbl(name,price,category_id) values('Apple',2500.00,1);
--insert into product_tbl(name,price,category_id) values('Durian',12000.00,1);
